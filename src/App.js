...
firebase.initializeApp({
  apiKey: "AIzaSyBRUNEix21CCM5b1J_WnhO9DdJzMXaJYMo",
  authDomain: "superchat-b2904.firebaseapp.com",
  projectId: "superchat-b2904",
  storageBucket: "superchat-b2904.appspot.com",
  messagingSenderId: "921426377829",
  appId: "1:921426377829:web:c987b85f8a2db6fcb71a8c",
})
...
function App() {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href="https://github.com/abioseth1">
          <header>
            <h1>💬 ⚛️ 🔥</h1>
          </header>
        </a>
